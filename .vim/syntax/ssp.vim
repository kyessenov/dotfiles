...
syn match keyword "#end"
syn region sspScriptlet matchgroup=sspTag start=/<%/  keepend end=/%>/ contains=@sspScala
syn region sspScriptlet matchgroup=sspTag start=/#{/  keepend end=/}#/ contains=@sspScala
syn region sspScriptlet matchgroup=sspTag start=/#if/  keepend end=/$/ contains=@sspScala
syn region sspScriptlet matchgroup=sspTag start=/#for/  keepend end=/$/ contains=@sspScala
